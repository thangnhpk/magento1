...
class Custom_Order_Block_Adminhtml_Order_Gird extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
       ...
       $this->addColumn('browser', array(
            'header' => Mage::helper('sales')->__('Broser'),
            'width'  =>'200px',
            'index' => 'browser',
            'filter_index' => 'sales_flat_order.browser',
        ));
        ...
        $this->addColumn('price', array(
            ...
            'type'  => 'text',
            'filter' =>false,
            'renderer' =>  'Custom_Order_Block_Adminhtml_Order_Renderer_Price',
        ));
